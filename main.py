...
class GameManager:
    def __init__(self):
        ...
        pygame.display.set_caption('飞机大战 - 优化版')
        
        # 游戏状态
        self.hit_score = 0
        self.is_pause = False
        
        # 优化：使用 Clock 控制帧率，代替 time.sleep
