...
class GameManager:
    ...
    def select_difficulty(self):
        ...
        # 按钮区域
        btn_easy_rect = pygame.Rect(150, 300, 180, 60)
        btn_normal_rect = pygame.Rect(150, 400, 180, 60)
        btn_hard_rect = pygame.Rect(150, 500, 180, 60)
        ...
        while True:
            ...
            self.window_screen.blit(title_text, (80, 150))
